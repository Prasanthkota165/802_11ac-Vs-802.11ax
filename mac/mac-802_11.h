...
/*
 10Mbps:
#define IEEE_80211_SLOT		0.000051200	// 512 bit times
#define	IEEE_80211_IFS		0.000009600	// 9.6us interframe spacing
 100Mbps:
#define IEEE_80211_SLOT                0.0000051200    //512 bit time
#define IEEE_80211_IFS                 0.0000009600    //0.96us interframe spacing
*/
#define IEEE_80211_SLOT_BITS             512.0 //when we divide these by the bandwidth
#define IEEE_80211_IFS_BITS               96.0 //we'll have what we want

#define IEEE_80211_ALIMIT	16		// attempt limit
#define IEEE_80211_BLIMIT	10		// backoff limit
#define IEEE_80211_JAMSIZE	32		// bits
#define IEEE_80211_MAXFRAME	1518		// bytes
#define IEEE_80211_MINFRAME	64		// bytes
...
public:
	MacHandler(Mac802_11* m) :  callback(0), mac(m), busy_(false) {}
...
class Mac80211HandlerSend : public MacHandler {
 public:
	Mac80211HandlerSend(Mac802_11* m) : MacHandler(m), p_(0) {}
	void handle(Event*);
...
public:
	MacHandlerRecv(Mac802_11* m) : MacHandler(m), p_(0) {}
	void handle(Event*);
...
class MacHandlerRetx : public MacHandler {
 public:
	MacHandlerRetx(Mac802_11* m) : MacHandler(m), p_(0), try_(1) {}
	void reset() {
...
class MacHandlerIFS : public MacHandler {
 public:
	MacHandlerIFS(Mac802_11* m) : MacHandler(m) {}
	void handle (Event*); 
...
class Mac802_11 : public Mac {
	...
	friend class Mac80211HandlerSend;
...
private:
	...
	Mac80211HandlerSend	mhSend_;
	
};


#endif /* __mac_802_11_h__ */
